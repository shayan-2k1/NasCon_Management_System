<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Participant_View.aspx.cs" Inherits="Participant_View" %>
...
<body>
    <form id="form1" runat="server">
        <div class="myDiv">
            ...
            <asp:Button ID="Button1" runat="server" Text="Registered Events" BackColor="#00CC00" OnClick="Button1_Click" Width="193px" />
